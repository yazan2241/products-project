            ...
            <div className={style.content}>
                <div className={style.rcontent}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button className={style.rlogin}>Register</button>
                    </form>

                    <div className={style.textLeft}>
                        <div className={style.registerText}>Already have an account</div>
                        <div className={style.registerText}>You can <a href='/login' className={style.registerButton}>Login here!</a></div>
                    </div>
